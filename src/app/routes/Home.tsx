            ...
            <div className='max-w-full'>
                <div className='p-4 w-full h-full justify-items-center grid grid-cols-[repeat(auto-fill,_minmax(150px,_1fr))] gap-x-2 gap-y-4 sm:gap-x-4'>
                    <div className='flex flex-col justify-center'>
                        <img alt='Tenet' className='h-[225px] w-[150px] rounded-2xl' src='https://m.media-amazon.com/images/M/MV5BYjI0NDQzYmEtNzMwZC00ODA3LTgzZDYtZTk5ODZjY2Y2OTkzXkEyXkFqcGc@._V1_.jpg' ></img>
